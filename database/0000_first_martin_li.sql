...
ALTER TABLE `cc_session` ADD CONSTRAINT `cc_session_userId_cc_user_id_fk` FOREIGN KEY (`userId`) REFERENCES `cc_user`(`id`) ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
